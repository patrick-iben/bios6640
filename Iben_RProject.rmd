...
####In terms of weekly malaria cases per thousand (under 5): the Northern region has the highest incidence of malaria (mean = 15.57, SD = 8.81), followed by the Coastal Region (mean = 12.06, SD = 6.63). These findings are to be expected, as malaria incidence is (historically) negatively related to altitude, and positively related to adjacency to water and humidity (https://www.cdc.gov/malaria/). Rainfall and temperature were highest in the coastal region (total rainfall: 112,179.28 mm; average temperature: 24.1 C). Rainfall was lowest in the southern region (total rainfall: 32,118.38 mm; average temperature: 23.27 C). The northern (total rainfall: 87,831.96 mm; average temperature: 22.76 C) and center regions (total rainfall: 96,737.14 mm; average temperature: 22.48 C) had roughly equal levels of rainfall and average temperatures.
